...
#NB! Find and replace: teachervm.teacher.exm, mail.teacher.exm, teacher.exm, teachervm 
...
mydestination = teacher.exm, teachervm.teacher.exm, mail.teacher.exm, localhost.teacher.exm, localhost
myhostname = teachervm.teacher.exm
...
@teachervm.teacher.exm @teacher.exm
