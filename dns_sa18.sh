...
options {
	...
	listen-on { 127.0.0.1; 192.168.25.8; };
	listen-on-v6 { none; };
...
@                 IN      NS      ns1
@                 IN      A       192.168.25.8
ns1               IN      A       192.168.25.8
teacher-vm        IN      A       192.168.25.8
@		          IN	  MX	  10 mail
mail		      IN	  A	      192.168.25.8
www		          IN      CNAME   teachervm
webmail		      IN 	  CNAME   teachervm
monitor		      IN	  CNAME   teachervm
info		      IN	  CNAME   teachervm
test		      IN	  CNAME   teachervm
nextcloud         IN      CNAME   teachervm
EOF
...
#
192.168.25.8 teachervm.teacher.exm teachervm
127.0.0.1 localhost
